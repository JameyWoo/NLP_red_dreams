...
def getBookBySearch(search_page_url_list, one_book_url_list, search_url_file):  # 在亚马逊的搜索页中查找相应书的url，并产生主页的url
...
if __name__ == '__main__':
    ...
    # getBookBySearch(search_page_url_list, one_book_url_list, r'comment_urls_WaterMargin.txt')
